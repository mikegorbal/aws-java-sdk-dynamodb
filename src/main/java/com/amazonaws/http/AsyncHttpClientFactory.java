...
public class AsyncHttpClientFactory {
     ...
     *
     * @param config Client configuration options (ex: proxy settings, connection
     *               limits, etc).
    ...
    public HttpClient createHttpClient(ClientConfiguration config) {
        ...
        if (config.useGzip()) {
            ...
            httpClient.addResponseInterceptor(new HttpResponseInterceptor() {
                ...
                @Override
                public void process(final org.apache.http.HttpResponse response,
                                    final HttpContext context) throws HttpException,
                        IOException {
    ...
    private static final class NeverFollowRedirectStrategy implements RedirectStrategy {
        ...
        @Override
        public boolean isRedirected(HttpRequest request, org.apache.http.HttpResponse response,
